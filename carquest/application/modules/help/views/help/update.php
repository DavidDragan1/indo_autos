...
<section class="content-header">
    <h1>Help<small><?php echo $button ?></small> </h1>
    <ol class="breadcrumb">
            ...
            <div class="box" style="margin-top: 28px;">
                ...
                <div class="box-body">
                    <div class="col-md-12">
                        ...
                        <div class="form-group">        
                            <label for="content" class="col-sm-3 control-label">Top FAQ</label>
                ...
                <div class="box-footer">
                    ...
                    <a href="help/delete/<?php echo $id;?>" onclick="return confirm('Confirm Delete?');" 
