            ...
            <form id="update_company_info" name="business_profile" action="" method="POST">
                <div class="row">
                    ...
                    <div class="col-md-8">
                            ...
                            <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-globe"></i>  URL</span>
                    ...
                    <div class="col-md-4">
                        ...
                        $thumb=GlobalHelper::getSellrCoverPhoto(!empty($cms_data)?$cms_data['thumb']:null);
