...
<head>
  ...
  <title>Log in - <?php echo getSettingItem( 'comName' ); ?></title>
  ...
  <div class="login-box-body">
    ...
    <div id="respond"></div>
      ...
      <div class="form-group has-feedback">
          <input type="text" id="username" value="admin@gmail.com" name="username" autocomplete="false" class="form-control" placeholder="Email">
        <span class="glyphicon glyphicon-envelope form-control-feedback"></span>
      </div>
      <span id='username_error'></span>
      
      <div class="form-group has-feedback">
          <input type="password" id="password" value="1234"   name="password" autocomplete="false" class="form-control" placeholder="Password">
...
<!-- jQuery 2.2.3 -->
<script  type="text/javascript" src="assets/lib/plugins/jQuery/jquery-2.2.3.min.js"></script>
<!-- Bootstrap 3.3.6 -->
<script type="text/javascript" src="assets/lib/bootstrap/js/bootstrap.min.js"></script>
<!-- iCheck -->
<script  type="text/javascript" src="assets/lib/plugins/iCheck/icheck.min.js"></script>
<script>
  $(function () {
    $('input').iCheck({
