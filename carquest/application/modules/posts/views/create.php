...
<section class="content">
    ...
    <div class="box">
        ...
        <div class="box-body">
            ...
            <div class="col-sm-12">
                <form class="form-horizontal" id="upload_new" action="<?php echo $action; ?>" method="post"
                    ...
                    <div class="form_fields">
                        ...
                        <div class="input-group">
                            <span class="input-group-addon"> <i
                                        class="fa fa-map-marker"></i> Location of the Product  <sup>*</sup></span>
                        ...
                        <div class="input-group">
                            <span class="input-group-addon"><i
                                        class="fa fa-unsorted"></i> Vehicle Category  <sup>*</sup></span>
                        ...
                        <div class="input-group">
                            <span class="input-group-addon"><i
                                        class="fa fa-check-square"></i> Vehicle Condition  <sup>*</sup></span>
                        ...
                        <?php else: ?>
                            ...
                            <div class="input-group">
                                <span class="input-group-addon"><i
                                            class="fa fa-user"></i> Seller Type<sup>*</sup></span>
                        ...
                        <div class="input-group">
                            <span class="input-group-addon" for="package_id"><i
                                        class="fa fa-user"></i> Listing Package<sup>*</sup></span>
                        ...
                        <a href="<?php echo site_url('admin/posts') ?>" class="btn btn-default"><i
                                    class="fa fa-arrow-left"></i> Cancel</a>
                        <button class="btn btn-primary" type="submit">Submit & Continue <i
