...
<?php if($this->session->flashdata('status')):
    ...
    <?php endif; ?>
<?php endif; ?>
<h2 class="breadcumbTitle">Add Towing</h2>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-md-6 col-12">
                                <div class="form-style">
                                    ...
                                    <div class="select2-wrapper select2-wrapper-black">
                                        <select class="input-style required" onchange="towing_servic(this)" id="towing_service_id" name="towing_service_id">
                                            <?php echo GlobalHelper::towing_services(0); ?>
                                        </select>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4 col-md-6 col-12">
                                <div class="form-style">
                                    ...
                                    <div class="select2-wrapper select2-wrapper-black">
                                        <select class="input-style required" onchange="towing_servic(this)" id="vehicle_type" name="vehicle_type">
                                            <?php echo GlobalHelper::getDropDownVehicleTypeTowing(0); ?>
                                        </select>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4 col-md-6 col-12">
                                <div class="form-style">
                                    ...
                                    <div class="select2-wrapper select2-wrapper-black">
                                        <select class="input-style required" onchange="towing_servic(this)" id="towing_type_of_service_id" name="towing_type_of_service_id">
                                            <?php echo GlobalHelper::towing_type_of_services(0, 0); ?>
                                        </select>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4 col-md-6 col-12">
                                <div class="form-style">
                                    ...
                                    <div class="select2-wrapper select2-wrapper-black">
                                        <select class="input-style required" id="availability" name="availability">
                                            <?php echo GlobalHelper::getDropDownAvailability(0); ?>
                                        </select>
                                    </div>
                                </div>
                            </div>
