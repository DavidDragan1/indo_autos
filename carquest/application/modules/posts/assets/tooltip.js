...
$('#Bodytype option:first').attr('value', '');
$('#manufacture_year option:first').attr('value', '');
$('#brandName option:first').attr('value', '');
$('#model_id option:first').attr('value', '');
$('#fueltype option:first').attr('value', '');
$('#Enginesize option:first').attr('value', '');
$('#seats option:first').attr('value', '');
$('#gearBox option:first').attr('value', '');
$('#color option:first').attr('value', '');
...
$(document).ready(function () {
    ...
    $('#post_details input[type="text"],  #post_details select, #upload_new input[type="text"],  #upload_new select ').tooltipster({
        trigger: 'custom',
        onlyOne: false,
        position: 'right'
    });
