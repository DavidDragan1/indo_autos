...
<section class="content-header">
    <h1> ask_expert  <small><?php echo $button ?></small> <a href="<?php echo site_url(Backend_URL . 'ask_expert') ?>" class="btn btn-default">Back</a> </h1>
    <ol class="breadcrumb">
...
<section class="content">       
    <div class="box">
        <div class="box-header with-border">
            <h3 class="box-title">Create New ask_expert</h3>
        </div>
