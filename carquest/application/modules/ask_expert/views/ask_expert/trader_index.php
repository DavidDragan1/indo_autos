<h2 class="breadcumbTitle">Ask an Expert Control panel</h2>
<!-- cars-area start -->
<div class="card-wrap-style-two faq-table-wrap">
    <h3 class="card-header-withbtn">Ask an Expert List <button data-toggle="modal" data-target="#addNewFaq"
                                                     class="header-btn">+ Add New</button>
    </h3>
    <div class="row">
        <div class="col-lg-4 offset-lg-8">
            <form class="search-form" action="<?php echo site_url(Backend_URL . 'ask_expert'); ?>" method="get">
    ...
    <div class="table-responsive">
        <table>
            ...
            $count = $count + 1;
            foreach ($ask_expert_data as $help) { ?>
                <tr>
                    ...
                    <td>
                        <ul class="actionsbtn">
                            <li><a href="ask_expert/read/<?php echo $help->id;?>"><i class="fa fa-eye"></i></a></li>
                            ...
                            <li><a href="ask_expert/delete/<?php echo $help->id;?>" onclick="return confirm('Do you really Delete this item?');">
...
<div class="modal fade modalWrapper" id="addNewFaq" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form class="row" method="post" action="admin/ask_expert/create_action">
                <div class="col-12 text-center">
                    <h3 class="title-add-car">Create New Ask an Expert</h3>
                </div>
                <div class="col-12">
...
<div class="modal fade modalWrapper" id="addNewUpdate" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form class="row" method="post" action="admin/ask_expert/update_action">
                <div class="col-12 text-center">
                    <h3 class="title-add-car">Update Ask an Expert</h3>
                </div>
                <div class="col-12">
                    <label class="input-label">Question</label>
