                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4"><?php echo $created; ?></div>

                            <div class="col-md-2">Postcode<span class="pull-right view_user_profile">:</span></div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                Last Access<span class="pull-right view_user_profile">:</span>
                            </div>
                            <div class="col-md-4">
                                <?php echo $last_access; ?>
                            </div>
                        </div> 
                ...
                <div class="panel-body">
                    <div class="profile_pic">
                        <?php if ($profile_photo) : ?>
                            <img src="uploads/ $profile_photo; ?>" class="img-responsive lazyload"/>
                        <?php else : ?>
                            <img src="<?php echo base_url() . 'uploads/default.jpg'; ?>" class="img-responsive lazyload"/>
                        <?php endif; ?>
                    </div>
                </div>
            </div>
