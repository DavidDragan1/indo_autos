...
<section class="content">
    <div class="box">
        <div class="box-header with-border">
            <h3 class="box-title">Update Availability</h3>
        </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <select class="form-control" name="term" id="term">
                        ...
                        <option value="Short Term" <?=$term == "Short Term" ? "selected" : ""?>>Short Term</option>
                        <option value="Middle Term" <?=$term == "Middle Term" ? "selected" : ""?>>Middle Term</option>
                        <option value="Long Term" <?=$term == "Long Term" ? "selected" : ""?>>Long Term</option>
                    </select>
