    ...
    <div class="panel panel-default">
        ...
        <div class="panel-heading">
            <h3 class="panel-title">
                <i class="fa fa-users" aria-hidden="true"></i> List of Clearing Product
            </h3>
        </div>
            ...
            <tbody>
                <?php foreach ($products as $key => $post) { ?>
                    <tr>
                        ...
                        <td>
                        <?php
                        echo anchor(site_url(Backend_URL . 'users/clearing-agent-product/update/' . $post->id), '<i class="fa fa-fw fa-edit"></i> Edit', 'class="btn btn-xs btn-default"');
                        echo anchor(site_url(Backend_URL . 'users/clearing-agent-product/delete/' . $post->id), '<i class="fa fa-fw fa-trash"></i> Delete ', 'class="btn btn-xs btn-danger" onclick="javasciprt: return confirm(\'Are You Sure ?\')"');
                        ?>
                        </td>
                    </tr>
                <?php } ?>
