...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="admin" class="logo">
      ...
      <span class="logo-mini"><img height="35" src="assets/admin/icons/logo-full.svg" alt="CA"></span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><img height="35" src="assets/admin/icons/logo-full.svg" alt="CarQuest"></span>
    </a>
...
<!--            <li><a target="_blank" href="--><?php //echo site_url( 'diagnostic'); ?><!--"><i class="fa fa-stethoscope"></i> Online Vehicle Diagnostic</a></li> -->
          <?php 
          
          $role_id = getLoginUserData('role_id');
          if(in_array($role_id, array(1,2,3))){ ?>
            <li><a href="<?php echo base_url( Backend_URL . 'help'); ?>"><i class="fa fa-question"></i> FAQ/Help</a></li>  
          <?php } else { ?>
            <li><a href="<?php echo base_url( 'faq'); ?>"><i class="fa fa-question"></i> FAQ/Help</a></li>  
          <?php }  ?>
          
           
          <li><a href="<?php echo base_url(); ?>"><i class="fa fa-globe"></i> Go to Home</a></li>  
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                <img src="<?=get_logged_user_photo_link()?>" class="img-circle" alt="User Image">
