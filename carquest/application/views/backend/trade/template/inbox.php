...
<div class="bg-white br-5 p-30 mb-50 products-statistics-wrap">
    ...
    <div class="card-top d-flex flex-wrap align-items-center justify-content-between mb-20">
        ...
        <ul class="table-header d-flex align-items-center flex-wrap justify-content-end ">
    ...
    <table id="all_adverts" class="table-wrapper ">
        ...
        <tr style="<?php if($mail->status === 'Unread'):?> color: #000; <?php endif;?>">
            ...
            <td>
                ...
                <a style="<?php if($mail->status === 'Unread'):?> color: #000; <?php endif;?>" class=" fw-500 open-mail" href="javascript:void(0)" data-mailid="<?php echo $mail->id; ?>"><?php echo getShortContent($mail->mail_from,15);?></a>
            </td>
            <td style="<?php if($mail->status === 'Unread'):?> color: #000; <?php endif;?>"><?php echo $mail->mail_type ?></td>
