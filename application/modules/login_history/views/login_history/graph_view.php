...
<section class="content-header">
    <h1> User Logs  <small>Graph view</small> </h1>
    <ol class="breadcrumb">
        <li><a href="<?php echo site_url( Backend_URL )?>"><i class="fa fa-dashboard"></i> Admin</a></li><li class="active">Login_history</li>
    </ol>
</section>
...
<script src="assets/lib/plugins/sparkline/jquery.sparkline.min.js"></script>
    ...
    <script>
      $(function () {
        ...
        var postChartData = {
            labels: <?php echo Modules::run('login_history/getChart'); ?>,
            datasets: [
                {
                    label: "Vendor",
                    fillColor: "#dd4b39",
                    ...
                    data: <?php echo Modules::run('login_history/getChartVendor'); ?>
                },
                {
                    label: "Customer",
                    fillColor: "#dd4b39",
                    ...
                    pointHighlightFill: "#fff",
                    pointHighlightStroke: "#dd4b39",
                    data: <?php echo Modules::run('login_history/getChartCustomer'); ?>
                }
            ]
        };
