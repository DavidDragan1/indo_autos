<h2 class="breadcumbTitle">Problem</h2>
<!-- cars-area start -->
<div class="card-wrap-style-two faq-table-wrap">
    <h3 class="card-header-withbtn">Problem List <button data-toggle="modal"
                                                               data-target="#mechanicDiagnosticQuestionsType" class="header-btn">+ Add New</button>
    </h3>
    <div class="row">
        <div class="col-lg-4 offset-lg-8">
            <form class="search-form" action="admin/diagnostics/problem" method="get">
        ...
        <table>
            ...
            foreach ($questions as $question) : ?>
                <tr>
                    ...
                    <td><?php echo $question->problem; ?></td>
                        ...
                        <ul class="actionsbtn">
                            <li>
                                <button onclick="update_period(this)" data-id="<?php echo $question->id; ?>"
                                        data-problem="<?php echo $question->problem; ?>"
                            ...
                            <li><a href="admin/diagnostics/delete-problem/<?php echo $question->id; ?>"
...
<div class="modal fade modalWrapper" id="mechanicDiagnosticQuestionsType" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form class="row" method="post" action="admin/diagnostics/problem-update">
                <div class="col-12 text-center">
                    <h3 class="title-add-car">Update Problem</h3>
                </div>
                <div class="col-12">
                    <label class="input-label">Select Question</label>
                    <div class="select2-wrapper">
                        <select class="input-style" name="question" id="question">
                            <?php echo makeQuestion(getLoginUserData('user_id')); ?>
                        </select>
                    </div>
                </div>
                <div class="col-12">
                    <label class="input-label">Problem Title</label>
                    <input name="problem" id="problem" type="text" class="inputbox-style" placeholder="Type Problem Title">
                </div>
...
<script>
    function update_period(element) {
        ...
        $("#problem").val($(element).data("problem"));
        CKEDITOR.instances['problemDescription'].setData($(element).data("description"))
        $("#question").val($(element).data("question")).change();
