        ...
        <input type="hidden" name="user_id" value="<?php echo $user_id; ?>" />
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    ...
                    <div class="form-group">
                        <label for="shipping_amount" class="col-sm-3 control-label">Shipping Amount :<?php echo form_error('shipping_amount') ?></label>
                        <div class="col-sm-9">
                            <input type="number" class="form-control" name="shipping_amount" id="shipping_amount" placeholder="Clearing Amount" value="<?php echo $shipping_amount; ?>" />
