<!-- hero-area start -->
<div class="hero-area hero-parts-area" style="background: url(assets/theme/new/images/motorbikes.jpg)no-repeat center center / cover">
    <div class="hero-content-wrap" onload="initialize()">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div class="hero-content">
                        <h1 class="animation">BUY & SELL MOTORBIKES </h1>
                    </div>
                </div>
                <div class="col-12">
                    <div class="search-wrapper">
                        <form action="motorbike" method="get">
                        <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-lg-3 col-sm-6 col-12">
                                        ...
                                        <select class="input-style" id="home_brand_id" name="brand_id" onChange="getModels(this.value);">
                                            <?php echo GlobalHelper::getBrand( 3 );?>
                                        </select>
                                        </div>
                                    </div>
                                    <div class="col-lg-3 col-sm-6 col-12">
                            ...
                            <div class="col-12 advance-searchWrap">
                                <div class="row">
                                    ...
                                    <div class="col-lg-7 col-12">
                                        <div class="row">
                                            <div class=" col-sm-6 col-12">
                                                <?php echo Modules::run('fuel_types/fuel_types_frontview/widget_home'); ?>
                                            </div>
                                            <div class=" col-sm-6 col-12">
                                                <div class="select2-wrapper">
                                    ...
                                    <div class="col-lg-4  col-sm-6 col-12">
                                        <div class="select2-wrapper">
                                            <select class="input-style" name="seller" id="seller">
                                    ...
                                    <div class="col-lg-4  col-sm-6 col-12">
                                        <div class="select2-wrapper">
                                        <select class="input-style" name="color_id">
                                            <?php echo GlobalHelper::createDropDownFromTable('color', 'color_name', 0, 'Any Color'); ?>
                                        </select>
                                        </div>
                                    </div>
            ...
            <div class="col-lg-4 col-md-6 col-12">
                <div class="products-wrap">
                        <span class="product-icon">
                            <img class="normal" src="assets/theme/new/images/icons/products/parts/icon1.png" alt="Find Your Specialist Automech">
                            <img class="hover" src="assets/theme/new/images/icons/products/parts/icon1-h.png" alt="Find Your Specialist Automech">
                        </span>
                    <h3><a href="automech">Find Your Specialist <br>Automech</a></h3>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 col-12">
                <div class="products-wrap">
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-6 col-12">
                <div class="featured-wrapper featured-wrapper-body-type">
                    <h2 class="featured-title">Fule type</h2>
                    <ul class="featured-list">
                        <li>
                            <a href="motorbike?type_id=3&fuel_type=6">
                                <img src="assets/theme/new/images/featured/body/car1.png" alt="image">
                                <span>Petrol</span>
                            </a>
                        </li>
                        <li>
                            <a href="motorbike?type_id=3&fuel_type=5">
                                <img src="assets/theme/new/images/featured/body/car2.png" alt="image">
                                <span>LPG</span>
                            </a>
                        </li>
                        <li>
                            <a href="motorbike?type_id=3&fuel_type=4">
                                <img src="assets/theme/new/images/featured/body/car3.png" alt="image">
                                <span>Hybrid</span>
                            </a>
                        </li>
                        <li>
                            <a href="motorbike?type_id=3&fuel_type=3">
                                <img src="assets/theme/new/images/featured/body/car4.png" alt="image">
                                <span>Electric</span>
                            </a>
                        </li>
                        <li>
                            <a href="motorbike?type_id=3&fuel_type=2">
                                <img src="assets/theme/new/images/featured/body/car6.png" alt="image">
                                <span>Diesel</span>
                            </a>
                        </li>
                        <li>
                            <a href="motorbike?type_id=3&fuel_type=1">
                                <img src="assets/theme/new/images/featured/body/car7.png" alt="image">
                                <span>Bi Fuel</span>
                            </a>
                        </li>
                    </ul>
            ...
            <div class="col-lg-4 col-md-6 col-12">
                <div class="featured-wrapper featured-wrapper-location">
                    ...
                    <ul class="location-list">
                        <?php echo GlobalHelper::getArea('motorbike',3); ?>
                    </ul>
                </div>
            </div>
        </div>
