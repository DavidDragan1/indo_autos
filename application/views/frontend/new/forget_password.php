    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-4 offset-lg-4">
                ...
                <form class="forgot_password-wrap" id="forgot_password" method="post">
                    <h4 class="fs-16 fw-500 mb-20">Recover Forgotten Password</h4>

                    <div class="input-field">
                        <input id="email" name="forgot_mail" type="email" required>
                        <label for="email"><span>Email Address</span></label>
                    </div>
                    <button type="submit" id="forgot_pass" class="loginBtn waves-effect mt-20">Recover Password</button>
                </form>
            </div>
        </div>
...
<div class="d-none" id="maingReport">
...
<script>
    jQuery('#forgot_pass').click(function(){
        var formData = jQuery('#forgot_password').serialize();
        ...
        jQuery.ajax({
            ...
            data: formData,
            beforeSend: function () {
                tosetrMessage('warning', 'Checking user...')
            },
