                    ...
                    <div class="col-md-4 col-sm-6 col-12">
                        <div class="select2-style mb-15">
                            <select name="vehicle_type_id" id="vehicle_type_id" onChange="vehicle_change(this.value);"
                                ...
                                <?php echo GlobalHelper::dropDownVehicleList(1); ?>
                            </select>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-6 col-12">
                        <div class="select2-style  mb-15">
                            <select id="condition" name="condition" class="browser-default input-change">
                                <?php echo GlobalHelper::getImportCarConditions(0); ?>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4 col-sm-6 col-12">
                        <div class="select2-style  mb-15">
                            <select id="brand_id" onChange="get_model(this.value);" name="brand_id"
                                ...
                                <?php echo Modules::run('brands/all_brands_for_automech', 0, 1); ?>
                            </select>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-6 col-12">
...
<!--                                --><?php //echo numericDropDown(1950, date('Y'), 1); ?>
                    ...
                    <div class="col-md-4 col-sm-6 col-12  car motorbike">
                        <div class="select2-style  mb-15">
                            <select id="fuel_type" name="fuel_id" class="browser-default input-change" required>
                    ...
                    <div class="col-md-4 col-sm-6 col-12 car motorbike">
                        <div class="select2-style  mb-15">
                            <select name="enginesize_id" id="engine_size"
                                    class="browser-default input-change" required>
                        ...
                        <div class="shadow br-5 p-15">
                            ...
                            <div id="amount">
                                ...
                                <div class="input-field input-field-icon mb-15">
                                    ...
                                    <input id="vehicle_amount" class="number input-change" name="vehicle_amount" type="text" placeholder="Enter Amount"/>
                                </div>
                            </div>
                            <div id="other">
                                <div class="input-field input-field-icon mb-15">
                                    <span class="field-icon color-theme">$</span>
                                    <input id="shipping_amount" class="number input-change"  name="shipping_amount" type="text" placeholder="Shipping Amount"/>
                                </div>
                                <div class="input-field input-field-icon mb-15">
                                    <span class="field-icon color-theme">$</span>
                                    <input id="ground_logistics" class="number input-change"  name="ground_logistics_amount" type="text" placeholder="Ground Logistics Amount"/>
                                </div>
                                <div class="input-field input-field-icon mb-15">
                                    <span class="field-icon color-theme ">$</span>
                                    <input id="customs" class="number input-change"  name="customs_amount" type="text" placeholder="Customs Amount"/>
                                </div>
                                <div class="input-field input-field-icon mb-15">
                                    <span class="field-icon color-theme">$</span>
                                    <input id="clearing" class="number input-change"  name="clearing_amount" type="text" placeholder="Clearing & Forwarding Amount"/>
                                </div>
                                <div class="input-field input-field-icon mb-15">
                                    <span class="field-icon color-theme">$</span>
                                    <input id="vat" class="number input-change"  name="vat_amount" type="text" placeholder="Vat"/>
                                </div>
                                <div class="col-12">
                                    <label class="checkbox-style">
                                        <input id="checkSingle-suggest" type="checkbox" class="filled-in checkSingle-suggest input-change" name="suggest_check"/>
                        ...
                        <div class="shadow p-15 br-5 mt-15">
                            <div class="details-pricing-wrap p-15" style="background: transparent;">
                                <div class="d-flex justify-content-between align-items-center ">
                                    <h4 class="fs-16 fw-500 color-theme
        ">Ammount Summary</h4>
                                </div>
                                <ul class="shipping_summary-list">
                                    <li>
                                        <span>Amount:</span>
                                        <span id="span_amount" class="color-black">$<span>0</span></span>
                                    </li>
                                    <li>
                                        <span>Shipping Amount:</span>
                                        <span id="span_shipping_amount" class="color-black">$<span>0</span></span>
                                    </li>
                                    <li>
                                        <span>Ground Logistics:</span>
                                        <span id="span_ground_logistics" class="color-black">$<span>0</span></span>
                                    </li>
                                    <li>
                                        <span>Customs:</span>
                                        <span id="span_customs" class="color-black">$<span>0</span></span>
                                    </li>
                                    <li>
                                        <span>Clearing:</span>
                                        <span id="span_clearing" class="color-black">$<span>0</span></span>
                                    </li>
                                    <li>
                                        <span>VAT(Value-added-tax):</span>
                                        <span id="span_vat" class="color-black">$<span>0</span></span>
                                    </li>
                                    <li>
...
<!--                        <span class="fs-14 color-seconday fw-500 mb-10 d-block">Enter Vehicle Amount</span>-->
<!--                        <div class="input-field input-field-icon mb-15">-->
<!--                            <span class="field-icon color-theme">-->
<!--                                <select id="pricein" name="pricein" class="input-change">-->
<!--                                <option value="USD">$</option>-->
<!--                            </select>-->
<!--                            </span>-->
<!---->
<!--                            <input id="vehicle_amount" class="number input-change" name="vehicle_amount" type="number"-->
<!--                                   placeholder="Enter Amount">-->
<!--                        </div>-->
<!--                    </div>-->
<!--                    <div class="col-md-4 col-sm-6 col-12">-->
<!--                                    <span-->
<!--                                        class="fs-14 color-seconday fw-500 mb-10 d-block d-flex align-items-center">Suggested-->
<!--                                        Vehicle-->
<!--                                        Amount-->
...
<!--                            <span class="suggestion-amount-pricein">$</span><span class="suggestion-amount-avg">0</span>-->
<!--                        </h5>-->
<!--                    </div>-->
<!---->
<!--                    <div class="col-12">-->
...
<!--                    </div>-->
        ...
        ">Shipping Summary</h4>
                                ...
                                <ul class="shipping_summary-list">
                                    <li>
                                        <span>Amount:</span>
                                        <span class="color-black">$ <span id="vehicle_amount_show">0</span></span>
                                    </li>
                                    <li>
                                        <span>Shipping Amount:</span>
                                        <span class="color-black">$ <span id="shipping_amount_show">0</span></span>
                                    </li>
                                    <li>
                                        <span>Ground Logistics:</span>
                                        <span class="color-black">$ <span id="ground_logistics_show">0</span></span>
                                    </li>
                                    <li>
                                        <span>Customs:</span>
                                        <span class="color-black">$ <span id="customs_show">0</span></span>
                                    </li>
                                    <li>
                                        <span>Clearing:</span>
                                        <span class="color-black">$<span id="clearing_show">0</span></span>
                                    </li>
                                    <li>
                                        <span>VAT(Value-added-tax):</span>
                                        <span class="color-black">$<span id="vat_show">0</span></span>
                                    </li>
                                    <li>
                                        <span class="fs-16 fw-500 color-black">Total</span>
...
<script>
    ...
    var priceinnaira = 0;
    var priceindoller = 0;
    var postType = '<?php echo $this->input->get('post_type', TRUE);?>'
    var post_id = 0;
...
<script>
    ...
    $(document).ready(function () {
        ...
        if (vehicle_type_id) {
            setStorage({'vehicle_type_id': vehicle_type_id, 'post_type': postType, 'pricein': 'NGR','country_id':countryId ,'listing_type' : listing_type, 'advert_type' : 'Free'});
        }
...
<script>
    ...
    //     if (vehicle_type_id == 4){
    //         $('#condition option[value="Foreign used"]').remove();
    //     }else{
    //         $('#condition option[value="Foreign used"]').remove();
    //         $('#condition').append('<option value="Foreign used">Foreign used</option>');
    //     }
    // }
