                    ...
                    <div class="col-md-4 col-sm-6 col-12">
                        <div class="select2-style  mb-15">
                            <select id="condition" name="condition" class="browser-default input-change">
                                <?php echo GlobalHelper::getConditions($data['condition']); ?>
                            </select>
                        </div>
                    </div>
...
<!--                                --><?php //echo GlobalHelper::all_tags($data['tags']); ?>
<!--                            </select>-->
<!--                        </div>-->
<!--                    </div>-->
<!--                </div>-->
                    ...
                    <div class="col-md-4 col-sm-6 col-12">
                        <div class="select2-style  mb-15">
                            <select name="location" id="location" class="browser-default input-change">
                                <?php echo GlobalHelper::all_city($data['location_id'], $data['location']); ?>
                            </select>
                        </div>
                    </div>
                    <div class="col-12">
            ...
            <fieldset class="step-wrapper">
                <div class="row">
                    <div class="col-md-4 col-sm-6 col-12">
<!--                        <span class="fs-14 color-seconday fw-500 mb-10 d-block">--><?//=$data['vehicle_amount']?><!--</span>-->
                        <div class="input-field input-field-icon mb-15">
                            <span class="field-icon color-theme">
                                ...
                                <option value="USD" <?= $data['pricein'] == 'USD' ? 'selected' : ''?>>$</option>
                            </select>
                            </span>

                            <input id="vehicle_amount" class="number input-change" value="<?=$data['vehicle_amount']?>" name="vehicle_amount" type="text"
                    ...
                    <div class="col-md-4 col-sm-6 col-12">
                        ...
                        <h5 class="fs-24 fw-500 color-theme d-flex align-items-center suggestion-amount bg-grey br-5 mb-15">
            ...
            <fieldset class="step-wrapper">
                ...
                foreach ($data['img'] as $k => $img){
                    $del_class = uniqid('del-')
                    ?>
                    <div id=""
                         class="d-flex flex-wrap upload_previews_template align-items-center <?=$del_class?>">
                        ...
                        <div class="preview-content">
                            <div class="preview-top d-flex">
                                ...
                                <span class="material-icons" onclick="removePhoto(this,'<?=$del_class?>', '<?=$img['name']?>', '<?=$data['id']?>')">
                                                close
                                            </span>
                    ...
                    <div class="col-lg-7">
                        <div class="vehicle-overview-wrap">
                            ...
                            <ul class="vehicle-overview-list">
                                <li class="vehicle-overview car motorbike">
        ...
        $('#vehicle_type_id, #condition, #brand_id, #model_id, #vehicle_type_id-show, #condition-show, #brand_id-show, #model_id-show').on('change', function () {
            ...
            jQuery.ajax({
                ...
                success: function (response) {
                    ...
                    var price =  priceinnaira > 0 ? `<span class="suggestion-amount-pricein">$ </span><span class="suggestion-amount-avg">${priceinnaira}</span>` : '<span class="suggestion-amount-avg">No suggested price</span>'
...
<script>
    ...
    function removePhoto(e,deleteClass, imgName, post_id){
        $('.'+deleteClass).remove();
...
<script>
    var postType = '<?php echo $vehicleId; ?>';
    if (parseInt(postType) === 4){
